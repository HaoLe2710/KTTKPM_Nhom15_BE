...
class CloseChatRoomUseCaseTest {
    ...
    @Test
    void executeClosesAssignedRoomSuccessfully() {
        ChatRepository chatRepository = Mockito.mock(ChatRepository.class);
        UserFacade userFacade = Mockito.mock(UserFacade.class);
        CloseChatRoomUseCase useCase = new CloseChatRoomUseCase(chatRepository, userFacade);
    ...
    @Test
    void executeThrowsWhenRoomAlreadyClosed() {
        ChatRepository chatRepository = Mockito.mock(ChatRepository.class);
        UserFacade userFacade = Mockito.mock(UserFacade.class);
        CloseChatRoomUseCase useCase = new CloseChatRoomUseCase(chatRepository, userFacade);
    ...
    @Test
    void executeThrowsWhenStaffDoesNotOwnRoom() {
        ChatRepository chatRepository = Mockito.mock(ChatRepository.class);
        UserFacade userFacade = Mockito.mock(UserFacade.class);
        CloseChatRoomUseCase useCase = new CloseChatRoomUseCase(chatRepository, userFacade);
        ...
        when(chatRepository.findRoomById("room-5")).thenReturn(Optional.of(room));
